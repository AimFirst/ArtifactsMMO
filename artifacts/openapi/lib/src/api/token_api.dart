...
class TokenApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [TokenResponseSchema] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<TokenResponseSchema>> generateTokenTokenPost({
    ...
    TokenResponseSchema? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(TokenResponseSchema),
    ...
    return Response<TokenResponseSchema>(
      data: _responseData,
