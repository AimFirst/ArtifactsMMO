...
class TasksApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [DataPageDropRateSchema] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<DataPageDropRateSchema>> getAllTasksRewardsTasksRewardsGet({
    int? page = 1,
    int? size = 50,
    ...
    DataPageDropRateSchema? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(DataPageDropRateSchema),
    ...
    return Response<DataPageDropRateSchema>(
      data: _responseData,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [DataPageTaskFullSchema] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<DataPageTaskFullSchema>> getAllTasksTasksListGet({
    int? minLevel,
    int? maxLevel,
    Skill? skill,
    TaskType? type,
    ...
    final _queryParameters = <String, dynamic>{
      ...
      if (skill != null)
        r'skill':
            encodeQueryParameter(_serializers, skill, const FullType(Skill)),
      if (type != null)
        r'type':
            encodeQueryParameter(_serializers, type, const FullType(TaskType)),
      if (page != null)
        r'page': encodeQueryParameter(_serializers, page, const FullType(int)),
      if (size != null)
        r'size': encodeQueryParameter(_serializers, size, const FullType(int)),
    ...
    DataPageTaskFullSchema? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(DataPageTaskFullSchema),
    ...
    return Response<DataPageTaskFullSchema>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [TaskFullResponseSchema] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<TaskFullResponseSchema>> getTaskTasksListCodeGet({
    ...
    final _path = r'/tasks/list/{code}'.replaceAll(
        '{' r'code' '}',
    ...
    TaskFullResponseSchema? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(TaskFullResponseSchema),
    ...
    return Response<TaskFullResponseSchema>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<RewardResponseSchema>> getTasksRewardTasksRewardsCodeGet({
    ...
    final _path = r'/tasks/rewards/{code}'.replaceAll(
        '{' r'code' '}',
        encodeQueryParameter(_serializers, code, const FullType(String))
            .toString());
    final _options = Options(
