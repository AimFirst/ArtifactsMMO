...
class ResourcesApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [DataPageResourceSchema] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<DataPageResourceSchema>> getAllResourcesResourcesGet({
    int? minLevel,
    int? maxLevel,
    ...
    final _queryParameters = <String, dynamic>{
      ...
      if (skill != null)
        r'skill': encodeQueryParameter(
            _serializers, skill, const FullType(GatheringSkill)),
      if (drop != null)
        r'drop':
            encodeQueryParameter(_serializers, drop, const FullType(String)),
      if (page != null)
    ...
    DataPageResourceSchema? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(DataPageResourceSchema),
    ...
    return Response<DataPageResourceSchema>(
      data: _responseData,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [ResourceResponseSchema] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ResourceResponseSchema>> getResourceResourcesCodeGet({
    ...
    final _path = r'/resources/{code}'.replaceAll(
        '{' r'code' '}',
    ...
    ResourceResponseSchema? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(ResourceResponseSchema),
    ...
    return Response<ResourceResponseSchema>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
