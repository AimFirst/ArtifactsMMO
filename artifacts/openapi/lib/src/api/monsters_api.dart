...
class MonstersApi {
  ...
  const MonstersApi(this._dio, this._serializers);
  ...
  Future<Response<DataPageMonsterSchema>> getAllMonstersMonstersGet({
    ...
    DataPageMonsterSchema? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(DataPageMonsterSchema),
    ...
    return Response<DataPageMonsterSchema>(
      data: _responseData,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [MonsterResponseSchema] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<MonsterResponseSchema>> getMonsterMonstersCodeGet({
    ...
    final _path = r'/monsters/{code}'.replaceAll(
        '{' r'code' '}',
    ...
    MonsterResponseSchema? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(MonsterResponseSchema),
    ...
    return Response<MonsterResponseSchema>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
