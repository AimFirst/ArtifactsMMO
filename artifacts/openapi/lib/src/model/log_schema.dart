...
abstract class LogSchema implements Built<LogSchema, LogSchemaBuilder> {
  ...
  LogType get type;
  // enum typeEnum {  spawn,  movement,  fight,  crafting,  gathering,  buy_ge,  sell_ge,  buy_npc,  sell_npc,  cancel_ge,  delete_item,  deposit_item,  withdraw_item,  deposit_gold,  withdraw_gold,  equip,  unequip,  new_task,  task_exchange,  task_cancelled,  task_completed,  task_trade,  christmas_exchange,  recycling,  rest,  use,  buy_bank_expansion,  achievement,  give_item,  give_gold,  receive_item,  receive_gold,  change_skin,  rename,  };
