...
abstract class CooldownSchema
  ...
  // enum reasonEnum {  movement,  fight,  crafting,  gathering,  buy_ge,  sell_ge,  cancel_ge,  delete_item,  deposit,  withdraw,  deposit_gold,  withdraw_gold,  equip,  unequip,  task,  recycling,  rest,  use,  buy_bank_expansion,  };
