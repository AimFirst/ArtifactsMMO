...
part of 'data_page_character_leaderboard_schema.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$DataPageCharacterLeaderboardSchema
    extends DataPageCharacterLeaderboardSchema {
  @override
  final BuiltList<CharacterLeaderboardSchema> data;
  @override
  final int? total;
  @override
  final int? page;
  ...
  bool operator ==(Object other) {
    ...
    return other is DataPageCharacterLeaderboardSchema &&
        data == other.data &&
        total == other.total &&
        page == other.page &&
        size == other.size &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'DataPageCharacterLeaderboardSchema')
          ..add('data', data)
          ..add('total', total)
          ..add('page', page)
          ..add('size', size)
...
class DataPageCharacterLeaderboardSchemaBuilder
    implements
        Builder<DataPageCharacterLeaderboardSchema,
            DataPageCharacterLeaderboardSchemaBuilder> {
  _$DataPageCharacterLeaderboardSchema? _$v;
  ...
  DataPageCharacterLeaderboardSchemaBuilder() {
    DataPageCharacterLeaderboardSchema._defaults(this);
  }

  DataPageCharacterLeaderboardSchemaBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  DataPageCharacterLeaderboardSchema build() => _build();

  _$DataPageCharacterLeaderboardSchema _build() {
