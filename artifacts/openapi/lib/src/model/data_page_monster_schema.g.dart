...
part of 'data_page_monster_schema.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$DataPageMonsterSchema extends DataPageMonsterSchema {
  @override
  final BuiltList<MonsterSchema> data;
  @override
  final int? total;
  @override
  final int? page;
  ...
  bool operator ==(Object other) {
    ...
    return other is DataPageMonsterSchema &&
        data == other.data &&
        total == other.total &&
        page == other.page &&
        size == other.size &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'DataPageMonsterSchema')
          ..add('data', data)
          ..add('total', total)
          ..add('page', page)
          ..add('size', size)
...
class DataPageMonsterSchemaBuilder
    implements Builder<DataPageMonsterSchema, DataPageMonsterSchemaBuilder> {
  _$DataPageMonsterSchema? _$v;
  ...
  DataPageMonsterSchemaBuilder() {
    DataPageMonsterSchema._defaults(this);
  }

  DataPageMonsterSchemaBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void update(void Function(DataPageMonsterSchemaBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  DataPageMonsterSchema build() => _build();

  _$DataPageMonsterSchema _build() {
