...
part of 'data_page_account_leaderboard_schema.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$DataPageAccountLeaderboardSchema
    extends DataPageAccountLeaderboardSchema {
  @override
  final BuiltList<AccountLeaderboardSchema> data;
  @override
  final int? total;
  @override
  final int? page;
  ...
  bool operator ==(Object other) {
    ...
    return other is DataPageAccountLeaderboardSchema &&
        data == other.data &&
        total == other.total &&
        page == other.page &&
        size == other.size &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'DataPageAccountLeaderboardSchema')
          ..add('data', data)
          ..add('total', total)
          ..add('page', page)
          ..add('size', size)
...
class DataPageAccountLeaderboardSchemaBuilder
    implements
        Builder<DataPageAccountLeaderboardSchema,
            DataPageAccountLeaderboardSchemaBuilder> {
  _$DataPageAccountLeaderboardSchema? _$v;
  ...
  DataPageAccountLeaderboardSchemaBuilder() {
    DataPageAccountLeaderboardSchema._defaults(this);
  }

  DataPageAccountLeaderboardSchemaBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void update(void Function(DataPageAccountLeaderboardSchemaBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  DataPageAccountLeaderboardSchema build() => _build();

  _$DataPageAccountLeaderboardSchema _build() {
