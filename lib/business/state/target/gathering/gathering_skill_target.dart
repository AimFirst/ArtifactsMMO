...
class GatheringSkillTarget extends GatheringTarget {
  ...
  @override
  List<Resource> getTargetResource({required Character character, required BoardState boardState}) {
    final currentSkill = getCurrentSkill(character: character, skillType: skillType);
