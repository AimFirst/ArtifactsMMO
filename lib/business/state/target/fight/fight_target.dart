...
abstract class FightTarget extends Target {
  FightTarget({required super.parentTarget, required super.characterLog});
  ...
  TargetProcessResult update(
    ...
    final heal = HealTarget(parentTarget: this, characterLog: characterLog).update(
        character: character,
    ...
    for (final monster in targetMonsters) {
      ...
      if (canDefeatMonster(character: character, monster: monster)) {
        ...
        // Move there.
        final moveAction = MoveToTarget(targetLocation: locations.first, parentTarget: this, characterLog: characterLog).update(
            character: character,
            boardState: boardState,
            artifactsClient: artifactsClient);
